...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/1/.claude/.gsd-surface.json`
(sibling to `/home/user/1/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/1/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/1/.claude/skills`).
...
`/home/user/1/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/1/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/1/.claude/.gsd-surface.json`
Install profile marker: `/home/user/1/.claude/.gsd-profile`
Skill dirs: `/home/user/1/.claude/skills/gsd-*/`
Engine module: `/home/user/1/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/user/1/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
