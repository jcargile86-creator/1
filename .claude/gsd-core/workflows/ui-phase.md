...
```markdown
Read /home/user/1/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/1/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/1/.claude/agents/gsd-ui-checker.md for instructions.
