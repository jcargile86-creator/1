...
<required_reading>
@/home/user/1/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@/home/user/1/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/1/.claude
                  → checks /home/user/1/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/1/.claude/gsd-core
                  → writes to /home/user/1/.claude/gsd-core/hooks/
...
@/home/user/1/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @/home/user/1/.claude/gsd-core/references/common-bug-patterns.md
